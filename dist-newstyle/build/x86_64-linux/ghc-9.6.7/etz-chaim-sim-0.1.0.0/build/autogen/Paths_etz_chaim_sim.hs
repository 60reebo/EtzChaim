...
libdir     = "/home/michaelmeresse/.cabal/lib/x86_64-linux-ghc-9.6.7/etz-chaim-sim-0.1.0.0-inplace"
...
getDynLibDir  = catchIO (getEnv "etz_chaim_sim_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "etz_chaim_sim_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "etz_chaim_sim_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "etz_chaim_sim_sysconfdir") (\_ -> return sysconfdir)
